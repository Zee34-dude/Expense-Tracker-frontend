...
function StatsCards({type}) {

  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mb-6">
      <StatCard title="Total balance" amount={type.balance} trendColor="text-green-500" trendValue="12.1%" />
      <StatCard title="Income" amount={type.totalIncome} trendColor="text-green-500" trendValue="6.4%" />
      <StatCard title="Expense" amount={type.totalExpense} trendColor="text-red-500" trendValue="3.1%" />
    </div>
  );
}
